...
// //校验属于当前访问用户的箱子(session) 有没有登录的登录标识
// session_start();

// if (empty($_SESSION['current_login_user'])) {
//   // 没有登录用户信息,以为着没有登录,跳转回去
//   header('Location: /admin/login.php');
// }

require_once '../functions.php';

//判断用户是否登录 一定是最先做,防止后面无意义的操作
zh_get_current_user();

// 获取所需要的数据 多次查找==>重复操作要封装起来
$posts_count = czh_fetch('select count(1) as num from posts;');
